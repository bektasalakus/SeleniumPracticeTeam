...
public class kiwiTest {
    ...
    public void testKiwi() throws InterruptedException {
        ...
        String fiyat = driver.findElement(By.xpath("(//strong[@class='ResultCardstyled__PriceText-sc-vsw8q3-8 fTIQNZ'])[1]")).getText();
        System.out.println(fiyat);

        fiyat=fiyat.replaceAll("\\D","");
        int cevirme = Integer.parseInt(fiyat);
        System.out.println(cevirme);

        Assert.assertTrue(cevirme<5000);
